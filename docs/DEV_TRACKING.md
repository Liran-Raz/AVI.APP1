...
**סטטוס:** ✅ R1 חי בייצור 2026-07-13 (PR #71). ✅ **R2 (ניהול-קבוצות) חי בייצור 2026-07-13** (PR #74, main
`15a1aa7`, `0025` הוחלה+אומתה, Vercel deploy + prod smoke ירוקים). R3/R4 פתוחים (כל אחד מוקאפ-קודם + סקירה
אדוורסרית). QA משמר-התנהגות אושר (Liran, יוזר-בודד); QA רב-משתמשי = Liran בפרודקשן.
