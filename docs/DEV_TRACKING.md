...
| DEV-020 | שלב 13 — חידודים ופיתוחים (חוויית לקוחות · התראות · דשבורד · צ'אט) | פיתוח (רב-סבב) | P2 | בתהליך | 2026-07-11 | 3 סבבים. **Round 1** (R1 לחיצת-שורת-לקוח · R2 עריכה בעמוד-לקוח · R3 התראות מעבר-מידע = מיגרציה `0021`, חיה) נבנה + QA אושר, במיזוג. **Round 2** = דשבורד owner (R4). **Round 3** = צ'אט (R5). ראה פירוט. |
...
**Round 2 (R4) + Round 3 (R5) — מתוכננים:** דשבורד owner (אגרגציות מ-`tasks` בלי מיגרציה,
גרפי SVG) · צ'אט "הודעות" (טבלת `messages` חדשה = מיגרציה 0022 + polling, DM + קבוצה).
