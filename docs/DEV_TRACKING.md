...
| DEV-020 | שלב 13 — חידודים ופיתוחים (חוויית לקוחות · התראות · דשבורד · צ'אט) | פיתוח (רב-סבב) | P2 | בתהליך | 2026-07-11 | 3 סבבים. **Round 1** (R1/R2/R3 + עדכון-לוח חי) **חי** (PR #59/#60, main `ecdae33`, מיגרציה `0021`). **Round 2 (R4)** = דשבורד ניהולי + גישה פר-משתמש שהבעלים פותח מעמוד "צוות" + תבנית מייל-הזמנה חדשה — **נבנה**, מיגרציה `0022`, ממתין להחלה+QA+מיזוג. **Round 3** = צ'אט (R5). ראה פירוט. |
...
**Round 2 (R4) — נבנה, ממתין להחלת `0022` + QA + מיזוג:**
...
**Round 3 (R5) — מתוכנן:** צ'אט "הודעות" (טבלת `messages` חדשה = מיגרציה 0023 + polling, DM + קבוצה).
