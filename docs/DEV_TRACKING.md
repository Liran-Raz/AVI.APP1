...
| DEV-002 | לחצן "מצאת תקלה?" בתוכנה + פופ-אפ דיווח + לוגים | פיתוח | P2 | בתהליך | 2026-07-06 | קוד בנוי ומאומת ב-[PR #41](https://github.com/Liran-Raz/AVI.APP1/pull/41). מיגרציה 0018 **הוחלה** ב-Production (2026-07-07). נותר: `BUG_REPORT_NOTIFY_EMAIL` ב-Vercel + מיזוג ה-PR. |
