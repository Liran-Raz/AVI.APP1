...
לכל משתמש** (הגדרות→אבטחה) **+ חובה משרדית** — בעל המשרד יכול לחייב 2FA לכל הצוות, ומשתמש שלא
הגדיר מקבל פופ-אפ עם כפתור להגדרות (אכיפה רכה: דחייה לסשן-דפדפן; חסימה-קשיחה = עתידי). SMS נדחה
(ספק בתשלום).
