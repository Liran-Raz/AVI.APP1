      ...
      <div className="mx-auto max-w-3xl px-4 py-10 sm:py-14">
        ...
        >
          <p className="rounded-lg border border-border bg-card p-4 text-foreground">
            ...
            להנגשת השירות לאנשים עם מוגבלות, ואת מצב הנגישות של האתר והאפליקציה נכון למועד העדכון שלמעלה.
          ...
          <section>
            ...
            <p>
              ...
              ובנוחות. אנו משקיעים משאבים בהנגשת השירות ובשיפורו המתמשך, מתוך אמונה שלכל אדם מגיעה זכות שווה
              לקבל שירות. השירות מופעל על-ידי{" "}
          ...
          <section>
            ...
            <p>
              האתר נבנה ומתוחזק בהתאם ל<strong>תקן הישראלי ת״י 5568</strong> להנגשת תכנים באינטרנט, המעוגן
              בהנחיות <strong>WCAG 2.0</strong> ברמה <strong>AA</strong>, ובהתאם לתקנות שוויון זכויות לאנשים
              עם מוגבלות (התאמות נגישות לשירות), התשע״ג-2013. יעד הנגישות שלנו הוא עמידה ברמה AA, ואנו פועלים
              לצמצום כל פער שמתגלה.
            </p>
          </section>
          ...
          <section>
            ...
            <ul>
              ...
              <li>הפעלה מלאה באמצעות מקלדת, עם חיווי-מיקוד (focus) גלוי לכל רכיב אינטראקטיבי;</li>
              ...
              <li>הצהרת שפה (עברית) וכיוון-כתיבה מימין-לשמאל (RTL);</li>
          ...
          <section>
            ...
            <p>
              אנו ממשיכים לשפר את נגישות השירות. נכון למועד זה ידועות לנו המגבלות הבאות, ואנו פועלים לתקנן:
            </p>
            <ul>
              <li>חלק מרכיבי-התצוגה הדקורטיביים בעמוד הבית (הדגמות חזותיות) עשויים להיקרא על-ידי קוראי-מסך;</li>
              <li>שיפורי ניגודיות-צבע בחלק מהטקסטים המשניים ותגי-הסטטוס;</li>
              <li>הצמדת הודעות-שגיאה בטפסים לשדה הרלוונטי והכרזתן על-ידי קוראי-מסך.</li>
            </ul>
            <p>
              אם נתקלת בחסם-נגישות שאינו מפורט כאן, נשמח שתעדכן אותנו — ראו ״דרכי פנייה״ להלן. נטפל בפנייה
              ונפעל לתיקון בהקדם הסביר.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              מתמקדים בהנגשת האתר והאפליקציה.
            </p>
          </section>
